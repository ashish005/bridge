...
var ValueService = (function () {
    ...
    ], ValueService.prototype, "gridOptionsWrapper");
    __decorate([
        context_2.Autowired('expressionService')
    ], ValueService.prototype, "expressionService");
    __decorate([
        context_2.Autowired('columnController')
    ], ValueService.prototype, "columnController");
    __decorate([
        context_2.Autowired('eventService')
    ], ValueService.prototype, "eventService");
    __decorate([
        context_3.PostConstruct
    ], ValueService.prototype, "init");
