...
var RenderedRow = (function () {
    ...
    RenderedRow.prototype.refreshGroupRow = function () {
        // where the toolkit-components go changes with pinning, it's easiest ot just remove from all containers
    ...
    ], RenderedRow.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('columnController')
    ], RenderedRow.prototype, "columnController");
    __decorate([
        context_1.Autowired('$compile')
    ], RenderedRow.prototype, "$compile");
    __decorate([
        context_1.Autowired('eventService')
    ], RenderedRow.prototype, "mainEventService");
    __decorate([
        context_1.Autowired('context')
    ], RenderedRow.prototype, "context");
    __decorate([
        context_1.Autowired('focusedCellController')
    ], RenderedRow.prototype, "focusedCellController");
    __decorate([
        context_1.Autowired('cellRendererService')
    ], RenderedRow.prototype, "cellRendererService");
    __decorate([
        context_1.PostConstruct
    ], RenderedRow.prototype, "init");
    return RenderedRow;
}());
