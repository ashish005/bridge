...
var DateCellEditor = (function (_super) {
    ...
    function DateCellEditor() {
        var _this = _super.call(this, DateCellEditor.TEMPLATE) || this;
        _this.eText = _this.queryForHtmlInputElement('input');
        _this.eButton = _this.queryForHtmlElement('button');
        _this.eButton.addEventListener('click', _this.onBtPush.bind(_this));
        return _this;
    }
    ...
    ], DateCellEditor.prototype, "popupService");
