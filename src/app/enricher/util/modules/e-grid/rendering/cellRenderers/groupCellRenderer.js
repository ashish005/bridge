...
var GroupCellRenderer = (function (_super) {
    ...
    ], GroupCellRenderer.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('expressionService')
    ], GroupCellRenderer.prototype, "expressionService");
    __decorate([
        context_1.Autowired('eventService')
    ], GroupCellRenderer.prototype, "eventService");
    __decorate([
        context_1.Autowired('cellRendererService')
    ], GroupCellRenderer.prototype, "cellRendererService");
    __decorate([
        context_1.Autowired('valueFormatterService')
    ], GroupCellRenderer.prototype, "valueFormatterService");
    __decorate([
        context_1.Autowired('context')
    ], GroupCellRenderer.prototype, "context");
    __decorate([
        context_1.Autowired('columnController')
    ], GroupCellRenderer.prototype, "columnController");
