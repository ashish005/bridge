...
var RenderedCell = (function (_super) {
    ...
    function RenderedCell(column, node, rowIndex, scope, renderedRow) {
        ...
        _this.gridCell = new gridCell_1.GridCell(rowIndex, node.floating, column);
        return _this;
    }
    ...
    ], RenderedCell.prototype, "context");
    __decorate([
        context_1.Autowired('columnApi')
    ], RenderedCell.prototype, "columnApi");
    __decorate([
        context_1.Autowired('gridApi')
    ], RenderedCell.prototype, "gridApi");
    __decorate([
        context_1.Autowired('gridOptionsWrapper')
    ], RenderedCell.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('expressionService')
    ], RenderedCell.prototype, "expressionService");
    __decorate([
        context_1.Autowired('rowRenderer')
    ], RenderedCell.prototype, "rowRenderer");
    __decorate([
        context_1.Autowired('$compile')
    ], RenderedCell.prototype, "$compile");
    __decorate([
        context_1.Autowired('templateService')
    ], RenderedCell.prototype, "templateService");
    __decorate([
        context_1.Autowired('valueService')
    ], RenderedCell.prototype, "valueService");
    __decorate([
        context_1.Autowired('eventService')
    ], RenderedCell.prototype, "eventService");
    __decorate([
        context_1.Autowired('columnController')
    ], RenderedCell.prototype, "columnController");
    __decorate([
        context_1.Optional('rangeController')
    ], RenderedCell.prototype, "rangeController");
    __decorate([
        context_1.Autowired('focusedCellController')
    ], RenderedCell.prototype, "focusedCellController");
    __decorate([
        context_1.Optional('contextMenuFactory')
    ], RenderedCell.prototype, "contextMenuFactory");
    __decorate([
        context_1.Autowired('focusService')
    ], RenderedCell.prototype, "focusService");
    __decorate([
        context_1.Autowired('cellEditorFactory')
    ], RenderedCell.prototype, "cellEditorFactory");
    __decorate([
        context_1.Autowired('cellRendererFactory')
    ], RenderedCell.prototype, "cellRendererFactory");
    __decorate([
        context_1.Autowired('popupService')
    ], RenderedCell.prototype, "popupService");
    __decorate([
        context_1.Autowired('cellRendererService')
    ], RenderedCell.prototype, "cellRendererService");
    __decorate([
        context_1.Autowired('valueFormatterService')
    ], RenderedCell.prototype, "valueFormatterService");
    __decorate([
        context_1.PostConstruct
    ], RenderedCell.prototype, "init");
    return RenderedCell;
