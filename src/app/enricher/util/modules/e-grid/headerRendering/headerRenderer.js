...
var HeaderRenderer = (function () {
    ...
    ], HeaderRenderer.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('columnController')
    ], HeaderRenderer.prototype, "columnController");
    __decorate([
        context_1.Autowired('gridPanel')
    ], HeaderRenderer.prototype, "gridPanel");
    __decorate([
        context_1.Autowired('context')
    ], HeaderRenderer.prototype, "context");
    __decorate([
        context_1.Autowired('eventService')
    ], HeaderRenderer.prototype, "eventService");
    __decorate([
        context_1.PostConstruct
    ], HeaderRenderer.prototype, "init");
