...
var MoveColumnController = (function () {
    ...
    ], MoveColumnController.prototype, "loggerFactory");
    __decorate([
        context_1.Autowired('columnController')
    ], MoveColumnController.prototype, "columnController");
    __decorate([
        context_1.Autowired('gridPanel')
    ], MoveColumnController.prototype, "gridPanel");
    __decorate([
        context_1.Autowired('dragAndDropService')
    ], MoveColumnController.prototype, "dragAndDropService");
    __decorate([
        context_1.Autowired('gridOptionsWrapper')
    ], MoveColumnController.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.PostConstruct
    ], MoveColumnController.prototype, "init");
