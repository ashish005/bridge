...
var BalancedColumnTreeBuilder = (function () {
    ...
    ], BalancedColumnTreeBuilder.prototype, "gridOptionsWrapper");
    __decorate([
        context_3.Autowired('columnUtils')
    ], BalancedColumnTreeBuilder.prototype, "columnUtils");
    __decorate([
        context_3.Autowired('context')
    ], BalancedColumnTreeBuilder.prototype, "context");
    __decorate([
        __param(0, context_2.Qualifier('loggerFactory'))
    ], BalancedColumnTreeBuilder.prototype, "setBeans");
