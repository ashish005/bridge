...
var ColumnApi = (function () {
    ...
    ], ColumnApi.prototype, "_columnController");
...
var ColumnController = (function () {
    ...
    ], ColumnController.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('expressionService')
    ], ColumnController.prototype, "expressionService");
    __decorate([
        context_1.Autowired('balancedColumnTreeBuilder')
    ], ColumnController.prototype, "balancedColumnTreeBuilder");
    __decorate([
        context_1.Autowired('displayedGroupCreator')
    ], ColumnController.prototype, "displayedGroupCreator");
    __decorate([
        context_1.Autowired('autoWidthCalculator')
    ], ColumnController.prototype, "autoWidthCalculator");
    __decorate([
        context_1.Autowired('eventService')
    ], ColumnController.prototype, "eventService");
    __decorate([
        context_1.Autowired('columnUtils')
    ], ColumnController.prototype, "columnUtils");
    __decorate([
        context_1.Autowired('gridPanel')
    ], ColumnController.prototype, "gridPanel");
    __decorate([
        context_1.Autowired('context')
    ], ColumnController.prototype, "context");
    __decorate([
        context_1.Autowired('pivotService')
    ], ColumnController.prototype, "pivotService");
    __decorate([
        context_1.PostConstruct
    ], ColumnController.prototype, "init");
    __decorate([
        __param(0, context_1.Qualifier('loggerFactory'))
    ], ColumnController.prototype, "setBeans");
