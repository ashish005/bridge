...
var GridPanel = (function () {
    ...
    ], GridPanel.prototype, "masterSlaveService");
    __decorate([
        context_1.Autowired('gridOptionsWrapper')
    ], GridPanel.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('columnController')
    ], GridPanel.prototype, "columnController");
    __decorate([
        context_1.Autowired('rowRenderer')
    ], GridPanel.prototype, "rowRenderer");
    __decorate([
        context_1.Autowired('floatingRowModel')
    ], GridPanel.prototype, "floatingRowModel");
    __decorate([
        context_1.Autowired('eventService')
    ], GridPanel.prototype, "eventService");
    __decorate([
        context_1.Autowired('rowModel')
    ], GridPanel.prototype, "rowModel");
    __decorate([
        context_1.Optional('rangeController')
    ], GridPanel.prototype, "rangeController");
    __decorate([
        context_1.Autowired('dragService')
    ], GridPanel.prototype, "dragService");
    __decorate([
        context_1.Autowired('selectionController')
    ], GridPanel.prototype, "selectionController");
    __decorate([
        context_1.Optional('clipboardService')
    ], GridPanel.prototype, "clipboardService");
    __decorate([
        context_1.Autowired('csvCreator')
    ], GridPanel.prototype, "csvCreator");
    __decorate([
        context_1.Autowired('mouseEventService')
    ], GridPanel.prototype, "mouseEventService");
    __decorate([
        context_1.Autowired('focusedCellController')
    ], GridPanel.prototype, "focusedCellController");
    __decorate([
        __param(0, context_1.Qualifier('loggerFactory'))
    ], GridPanel.prototype, "agWire");
    __decorate([
        context_1.PostConstruct
    ], GridPanel.prototype, "init");
