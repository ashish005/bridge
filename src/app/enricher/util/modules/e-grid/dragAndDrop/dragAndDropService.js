...
var DragAndDropService = (function () {
    ...
    */
    ...
    ], DragAndDropService.prototype, "gridOptionsWrapper");
    __decorate([
        context_3.Autowired('dragService')
    ], DragAndDropService.prototype, "dragService");
    __decorate([
        context_3.Autowired('columnController')
    ], DragAndDropService.prototype, "columnController");
    __decorate([
        context_1.PostConstruct
    ], DragAndDropService.prototype, "init");
    __decorate([
        __param(0, context_1.Qualifier('loggerFactory'))
    ], DragAndDropService.prototype, "setBeans");
