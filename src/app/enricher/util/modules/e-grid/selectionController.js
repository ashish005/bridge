...
var SelectionController = (function () {
    ...
    ], SelectionController.prototype, "eventService");
    __decorate([
        context_3.Autowired('rowModel')
    ], SelectionController.prototype, "rowModel");
    __decorate([
        context_3.Autowired('gridOptionsWrapper')
    ], SelectionController.prototype, "gridOptionsWrapper");
    __decorate([
        __param(0, context_2.Qualifier('loggerFactory'))
    ], SelectionController.prototype, "setBeans");
    __decorate([
        context_4.PostConstruct
    ], SelectionController.prototype, "init");
