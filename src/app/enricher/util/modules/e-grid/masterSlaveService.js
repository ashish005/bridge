...
var MasterSlaveService = (function () {
    ...
    ], MasterSlaveService.prototype, "gridOptionsWrapper");
    __decorate([
        context_3.Autowired('columnController')
    ], MasterSlaveService.prototype, "columnController");
    __decorate([
        context_3.Autowired('gridPanel')
    ], MasterSlaveService.prototype, "gridPanel");
    __decorate([
        context_3.Autowired('eventService')
    ], MasterSlaveService.prototype, "eventService");
    __decorate([
        __param(0, context_2.Qualifier('loggerFactory'))
    ], MasterSlaveService.prototype, "setBeans");
    __decorate([
        context_4.PostConstruct
    ], MasterSlaveService.prototype, "init");
