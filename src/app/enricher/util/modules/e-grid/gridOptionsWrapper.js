...
var GridOptionsWrapper = (function () {
    ...
    ], GridOptionsWrapper.prototype, "gridOptions");
    __decorate([
        context_1.Autowired('columnController')
    ], GridOptionsWrapper.prototype, "columnController");
    __decorate([
        context_1.Autowired('eventService')
    ], GridOptionsWrapper.prototype, "eventService");
    __decorate([
        context_1.Autowired('enterprise')
    ], GridOptionsWrapper.prototype, "enterprise");
    __decorate([
        __param(0, context_1.Qualifier('gridApi')), __param(1, context_1.Qualifier('columnApi'))
    ], GridOptionsWrapper.prototype, "agWire");
    __decorate([
        context_1.PostConstruct
    ], GridOptionsWrapper.prototype, "init");
