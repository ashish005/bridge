...
var PaginationController = (function () {
    ...
    ], PaginationController.prototype, "filterManager");
    __decorate([
        context_2.Autowired('gridPanel')
    ], PaginationController.prototype, "gridPanel");
    __decorate([
        context_2.Autowired('gridOptionsWrapper')
    ], PaginationController.prototype, "gridOptionsWrapper");
    __decorate([
        context_2.Autowired('selectionController')
    ], PaginationController.prototype, "selectionController");
    __decorate([
        context_2.Autowired('sortController')
    ], PaginationController.prototype, "sortController");
    __decorate([
        context_2.Autowired('eventService')
    ], PaginationController.prototype, "eventService");
    __decorate([
        context_2.Autowired('rowModel')
    ], PaginationController.prototype, "rowModel");
    __decorate([
        context_3.PostConstruct
    ], PaginationController.prototype, "init");
