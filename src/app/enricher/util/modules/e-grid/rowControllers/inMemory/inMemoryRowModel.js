...
var InMemoryRowModel = (function () {
    ...
    ], InMemoryRowModel.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('columnController')
    ], InMemoryRowModel.prototype, "columnController");
    __decorate([
        context_1.Autowired('filterManager')
    ], InMemoryRowModel.prototype, "filterManager");
    __decorate([
        context_1.Autowired('$scope')
    ], InMemoryRowModel.prototype, "$scope");
    __decorate([
        context_1.Autowired('selectionController')
    ], InMemoryRowModel.prototype, "selectionController");
    __decorate([
        context_1.Autowired('eventService')
    ], InMemoryRowModel.prototype, "eventService");
    __decorate([
        context_1.Autowired('context')
    ], InMemoryRowModel.prototype, "context");
    __decorate([
        context_1.Autowired('pivotService')
    ], InMemoryRowModel.prototype, "pivotService");
    __decorate([
        context_1.Autowired('filterStage')
    ], InMemoryRowModel.prototype, "filterStage");
    __decorate([
        context_1.Autowired('sortStage')
    ], InMemoryRowModel.prototype, "sortStage");
    __decorate([
        context_1.Autowired('flattenStage')
    ], InMemoryRowModel.prototype, "flattenStage");
    __decorate([
        context_1.Optional('groupStage')
    ], InMemoryRowModel.prototype, "groupStage");
    __decorate([
        context_1.Optional('aggregationStage')
    ], InMemoryRowModel.prototype, "aggregationStage");
    __decorate([
        context_1.PostConstruct
    ], InMemoryRowModel.prototype, "init");
