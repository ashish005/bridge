...
var RowNode = (function () {
    ...
    ], RowNode.prototype, "mainEventService");
    __decorate([
        context_1.Autowired('gridOptionsWrapper')
    ], RowNode.prototype, "gridOptionsWrapper");
    __decorate([
        context_1.Autowired('selectionController')
    ], RowNode.prototype, "selectionController");
    __decorate([
        context_1.Autowired('columnController')
    ], RowNode.prototype, "columnController");
    __decorate([
        context_1.Autowired('valueService')
    ], RowNode.prototype, "valueService");
    __decorate([
        context_1.Autowired('rowModel')
    ], RowNode.prototype, "rowModel");
    return RowNode;
}());
